...
<body style="background: #f4f4f4; font-family: Arial; font-size: 12px;">
	...
	<div class="row">
		<form action="consultarAlterarAutores" th:action="@{/consultarAlterarAutores}"
				th:object="${autor}" method="post">
			<div class="col-xs-12 margin-top-20">
				<div class="row" style="margin-top: 20px">
					<div class="col-xs-12 col-xs-offset-5">
						<b style="text-align: center; font-size: 150%">Alterar
							Autor</b>
					</div>
				</div>
			</div>
	...
	<div style="width: 1043px; margin: auto">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="row" id="topoFiltro" style="cursor: pointer;">
					<div class="col-xs-11">
						<b>Formulário de cadastro de Autor</b>
					</div>
				</div>

				<hr style="margin-top: 10px; border: 1px dotted #CCC;">
				 <c:if test="${alterar eq 1}">
					<div class="alert alert-success">
						<strong>Sucesso!</strong> Autor alterado com sucesso.
					</div>
				</c:if>
				<div class="col-xs-12">
			<form action="alterAutor" th:action="@{/alterAutor}" th:object="${autor}" method="post">
			...
			<input type="hidden" name="endereco.idAutor" value="${autor.id}">
						<div class="col-xs-12">
							<div class="row">
								<div class="col-xs-4">
									Número Cpf: <span style="color: red">*</span> <input
								...
								<div class="col-xs-4">
									Nome Citação : <span style="color: red">*</span> <input
							...
							<div class="row">
								...
								<div class="col-xs-8">
									Endereço <span style="color: red">*</span> <input
							...
							<div class="row">
								<div class="col-xs-2 col-xs-offset-8">
									<button type="submit" class="btn btn-primary" id="btnConsultar">Alterar</button>
								</div>
								<div class="col-xs-1">
