				...
				<hr style="margin-top: 10px; border: 1px dotted #CCC;">
				 <c:if test="${incluir eq 1}">
					<div class="alert alert-success">
						<strong>Sucesso!</strong> Autor incluído com sucesso.
					</div>
				</c:if>
				 <c:if test="${cpfValido}">
					<div class="alert alert-success">
						<strong>Sucesso!</strong> CPF é válido.
					</div>
				</c:if>
				<c:if test="${cpfInvalido}">
					<div class="alert alert-info">
						<strong>Atenção!</strong> CPF não é válido.
					</div>
				</c:if>
				<div class="col-xs-12">
							...
							<div class="col-xs-4">
								...
								<div style="margin-top: 17px;" class="col-xs-2">
									<button class="btn btn-primary"  type="submit" value="buscarEndereco" name="endereco.endereco"  onclick="buscarEndereco()"
										id="btnConsultarEnd">Buscar Endereço</button>
								</div>
							<div class="col-xs-6">
								Endereço <span style="color: red">*</span> <input type="text" id="endereco"
