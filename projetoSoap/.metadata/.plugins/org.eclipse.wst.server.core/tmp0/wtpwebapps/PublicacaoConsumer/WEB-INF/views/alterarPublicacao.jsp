...
<body style="background: #f4f4f4; font-family: Arial; font-size: 12px;">
	...
	<div class="row">
		<form action="alterarPublicacao" th:action="@{/alterarPublicacao}"
	...
	<div style="width: 1043px; margin: auto">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="row" id="topoFiltro" style="cursor: pointer;">
					<div class="col-xs-11">
						<b>Formulário de Cadastro de Publicação</b>
					</div>
				</div>
				...
				<hr style="margin-top: 10px; border: 1px dotted #CCC;">
				 <c:if test="${alterar eq 1}">
					<div class="alert alert-success">
						<strong>Sucesso!</strong> Publicação alterada com sucesso.
					</div>
				</c:if>
				<div class="col-xs-12">
				<form action="alterPublicacao" th:action="@{/alterPublicacao}" th:object="${publicacoes}" method="post">
						<input type="hidden" name="id" value="${publicacao.id}">
						<div class="col-xs-12">
							<div class="row">
								<div class="col-xs-12">
									Nome Título: <span style="color: red">*</span> <input
							...
							<div class="row">
								...
								<div class="col-xs-4">
									Data Publicação: <span style="color: red">*</span> <input
